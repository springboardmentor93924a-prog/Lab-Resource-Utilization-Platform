...
public class EquipmentController {
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('INSTITUTION_ADMIN', 'SUPER_ADMIN', 'LAB_MANAGER')")
    public ResponseEntity<EquipmentResponse> createEquipment(
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('INSTITUTION_ADMIN', 'SUPER_ADMIN', 'LAB_MANAGER', 'FACULTY', 'STUDENT')")
    public ResponseEntity<List<EquipmentResponse>> getAllEquipment() {
    ...
    @GetMapping("/institution/{institutionId}")
    @PreAuthorize("hasAnyRole('INSTITUTION_ADMIN', 'SUPER_ADMIN', 'LAB_MANAGER', 'FACULTY')")
    public ResponseEntity<List<EquipmentResponse>>
    getEquipmentByInstitution(
            @PathVariable String institutionId
    ) {
