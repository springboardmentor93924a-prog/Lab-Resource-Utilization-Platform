...
public class EquipmentDto {
    ...
    private java.math.BigDecimal externalHourlyRate;
    ...
    public static EquipmentDto fromEntity(Equipment e, EquipmentCalibration latestCalibration) {
        ...
        dto.setLabId(e.getLabId());
        dto.setPurchaseDate(e.getPurchaseDate());
        dto.setPurchaseCost(e.getPurchaseCost());
        dto.setHourlyRate(e.getHourlyRate());
        dto.setExternalHourlyRate(e.getExternalHourlyRate());
        dto.setCondition(e.getCondition());
        dto.setIsActive(e.getIsActive() != null ? e.getIsActive() : true);
