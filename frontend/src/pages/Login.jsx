      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl px-10 pt-12 pb-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-right -mt-2">
            <a
              href="#"
              className="text-sm text-gray-500 hover:text-slate-900 transition"
            >
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full h-12 bg-slate-900 text-white rounded-lg text-sm font-semibold hover:bg-slate-800 transition disabled:opacity-60"
          >
