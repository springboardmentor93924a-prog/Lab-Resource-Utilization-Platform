...
import StaffPasswordSetupPage from "./auth/StaffPasswordSetupPage.jsx";
...
export default function App() {
  ...
  const [page, setPage] = useState(hasToken ? "accept-invitation" : "landing");
  ...
  return (
    <div className="font-sans">
      ...
      {page === "accept-invitation" && (
        <StaffPasswordSetupPage goTo={goTo} toast={push} onSetupComplete={() => goTo("login")} />
      )}
