...
function Categories() {
  ...
  const [categories, setCategories] = useState([
    {
      id: "CAT001",
      name: "Electronics",
      description: "Electronic laboratory instruments and devices",
      equipment: 12,
      status: "Active",
    },
    {
    ...
    },
    {
      id: "CAT003",
      name: "Optical",
      description: "Optical and spectroscopy equipment",
      equipment: 6,
      status: "Active",
    },
    {
    ...
    },
    {
      id: "CAT005",
      name: "Safety",
      description: "Laboratory safety equipment",
      equipment: 4,
      status: "Inactive",
    },
  ]);
  ...
  const totalEquipment = categories.reduce(
    (total, item) => total + item.equipment,
    0
  );
    ...
    >
      ...
      >
        <div>
          ...
          >
            Organize and manage laboratory equipment categories
          </p>
        </div>
