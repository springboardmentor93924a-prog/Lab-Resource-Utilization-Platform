...
public class InstitutionServiceImpl implements InstitutionService {
    ...
    @Override
    public InstitutionResponse getInstitutionById(
            String institutionId
    ) {
    ...
    public InstitutionResponse updateInstitution(
        ...
        boolean emailChanged =
                !institution.getEmail().equalsIgnoreCase(request.getEmail());

        boolean nameChanged =
                !institution.getName().equalsIgnoreCase(request.getName());
        ...
        if (
                nameChanged &&
                        institutionRepository.existsByName(request.getName())
        ) {
            throw new RuntimeException(
                    "Institution with this name already exists"
            );
